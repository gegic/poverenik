...
import com.xml.team18.poverenik.model.zahtev.BiranjeZahteva;
import com.xml.team18.poverenik.model.zahtev.IzborZahteva;
...
public class ZahtevFactory extends PoverenikFactory {
  ...
  private static final QName _Zahtev_QNAME = new QName("", "zahtev");
  private static final QName _ZahtevOrgan_QNAME = new QName("", "organ");
  private static final QName _ZahtevNaslov_QNAME = new QName("", "naslov");
  private static final QName _ZahtevZakon_QNAME = new QName("", "zakon");
  private static final QName _ZahtevTipZahteva_QNAME = new QName("", "tip-zahteva");
  private static final QName _ZahtevTipInformacije_QNAME = new QName("", "tip-informacije");
  private static final QName _ZahtevMesto_QNAME = new QName("", "mesto");
  private static final QName _ZahtevTrazilacInformacije_QNAME =
      new QName("", "trazilac-informacije");
  ...
  public JAXBElement<BiranjeZahteva> createZahtevTipZahteva(BiranjeZahteva value) {
    return new JAXBElement<BiranjeZahteva>(
        _ZahtevTipZahteva_QNAME, BiranjeZahteva.class, Zahtev.class, value);
  }
  ...
  public JAXBElement<Osoba> createZahtevTrazilacInformacije(Osoba value) {
    return new JAXBElement<Osoba>(
        _ZahtevTrazilacInformacije_QNAME, Osoba.class, Zahtev.class, value);
  }
}
