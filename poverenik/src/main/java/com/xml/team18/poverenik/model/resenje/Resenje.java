...
public class Resenje {
    ...
    @XmlElement(required = true)
    protected Resenje.Zalba zalba;
    @XmlElement(required = true)
    protected PodnetiZahtev zahtev;
    @XmlElement(required = true)
    protected Resenje.Osnov osnov;
    @XmlElement(required = true)
    protected Telo telo;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setZalba(Resenje.Zalba value) {
        this.zalba = value;
    }
     ...
     *     
     */
    public void setOsnov(Resenje.Osnov value) {
        this.osnov = value;
    }
    ...
    public static class Zalba {
        ...
        protected Resenje.Zalba.Obavestenje obavestenje;
         ...
         * @return
         *     possible object is
         *     {@link Resenje.Zalba.Obavestenje }
         *     
         */
        public Resenje.Zalba.Obavestenje getObavestenje() {
            return obavestenje;
        }
         ...
         *     
         */
        public void setObavestenje(Resenje.Zalba.Obavestenje value) {
