...
public class JaxB {
    ...
    public Object unmarshall(String text, Class<?> clazz, Class<?> factoryClazz) throws JAXBException {
    ...
    public String marshall(Object toMarshall, Class<?> clazz, Class<?> factoryClazz) throws JAXBException {
        JAXBContext context = JAXBContext.newInstance(clazz, factoryClazz);
