...
<zahtev
        ...
        rdfa_z="http://team14.xml.com/rdf/zahtevi"
        rdfa_pred="http://team14.xml.com/rdf/zahtevi/predicate/"
>
    <organ>
        <adresa/>
        <naziv></naziv>
    ...
    <tip-zahteva/>
    <opis-zahteva></opis-zahteva>
    <mesto></mesto>
    <datum>${new Date().toISOString().slice(0, 10)}</datum>
    <trazilac-informacije/>
</zahtev>`;
